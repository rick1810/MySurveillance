...
public class MaxSize extends Reason {
	...
	public String html() {
		...
		return "<div><p>Reason:</p><input key=\"size\" type=\"number\" min=\"1\" max=\"1024\" id=\"reason\" value=\"" + size.toString() + "\"/><p>" + unit.toString().toUpperCase() + "</p><input hidden key=\"unit\" value=\"" + unit.toString() + "\"</div>";
	};
